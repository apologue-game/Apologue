...
public class VerticalSnailAI : MonoBehaviour, IEnemy
{
    ...
    private void FixedUpdate()
    {
        ...
        distance = transform.position.y - positions[movingTowardsIndex].position.y;
        ...
        rigidBody2D.velocity = new Vector2(rigidBody2D.velocity.x, direction * speed);
    }
